...
public class Bouclier {
	...
	public Point calculerCentreSymetrie(){
		...
		/*
		int xCentreSymetrie = (int) ( pente * abscisseOrigineAxeSymetrie - pente * ( Math.pow(pente, 2) * abscisseOrigineAxeSymetrie + abscisseOrigineAxeProjection) / (1 + pente) );
		int yCentreSymetrie = (int) ( (Math.pow(pente, 2) * abscisseOrigineAxeSymetrie + abscisseOrigineAxeProjection) / (1 + pente) );
		*/
